...
public class AdapterGrid extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //Recupera dados da img e iremos colocar as imgs dentro das views
        String urlImagem = getItem(position); // <-- recupera o 1 item da postagem
        ImageLoader imageLoader = ImageLoader.getInstance(); // configura imageloader
